...
class ParserModel(nn.Module):
    ...
    def forward(self, w):
        ...
        hiddenl_layer = relu(torch.matmul(
            X, self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
        logits = torch.matmul(
            hiddenl_layer, self.hidden_to_logits_weight) + self.hidden_to_logits_bias
